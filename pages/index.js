    ...
    <>
                      ...
                      <div className="space-y-5 xl:col-span-3">
                        <div className="space-y-1">
                          ...
                          <div className="text-base font-medium leading-6">
                            <Link
                              href={`/blog/${slug}`}
                              className="special-underline text-gray-900 hover:text-gray-500 dark:text-gray-100 dark:hover:text-gray-600"
      ...
      {posts.length > MAX_DISPLAY && (
        <div className="flex justify-end pt-6 text-lg font-normal leading-6">
          <Link
            href="/blog"
            className=" special-underline text-primary-800 hover:text-gray-900 hover:no-underline dark:text-primary-500 hover:dark:text-gray-700"
